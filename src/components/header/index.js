        ...
        <Container>
            ...
            <NavMobile>
                ...
                <nav className={openMenu !== true ? '' : 'open'}>
                    <ul>
                        <li onClick={handleOpenMenu}><Links to="/" exact activeStyle={{color:'#4717F6'}}>Home</Links></li>
                        <li onClick={handleOpenMenu}><Links to="/sobre" activeStyle={{color:'#4717F6'}}>Sobre mim</Links></li>
                        <li onClick={handleOpenMenu}><Links to="/resumo" activeStyle={{color:'#4717F6'}}>Resumo</Links></li>
                        <li onClick={handleOpenMenu}><Links to="/portfolio" activeStyle={{color:'#4717F6'}} >Portfolio</Links></li>
                        <li onClick={handleOpenMenu}><Links to="/contato" activeStyle={{color:'#4717F6'}}>Contato</Links></li>
                    </ul>
                </nav>
            </NavContainer>
            <Footer>
